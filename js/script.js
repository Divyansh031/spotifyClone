...
async function displayAlbums() {
    ...
    cardContainer.innerHTML = "" //Clear Old Playlist
...
async function main() {
    ...
    //Attch and event listener to play,next and previous
    ...
    previous.addEventListener("click", () => {
        ...
        // Find the current song index in the songs array
        let index = songs.findIndex(song => song === currentSongName);
